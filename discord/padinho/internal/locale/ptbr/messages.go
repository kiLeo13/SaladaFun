...
const (
	...
	AccountTreeTitle              = "## Árvore de <@%d>"
	AccountTreeOneAccount         = "-# 1 conta total"
	AccountTreeManyAccounts       = "-# %d contas totais"
	AccountTreeInvalidID          = "Informe um ID de usuário válido."
	AccountTreeUserNotFound       = "Não encontrei esse usuário no servidor."
